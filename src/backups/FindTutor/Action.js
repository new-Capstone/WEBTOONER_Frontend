...
const Action = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        setActionPortfolioList(response.data);
      })
      .catch((error) => console.log(error));
  }, []);

  console.log(actionPortfolioList);
  ...
  const records = actionPortfolioList.slice(firstIndex, lastIndex);

  const npage = Math.ceil(actionPortfolioList.length / recordsPerPage);
